...
インタプリタが動くと、文字列やリスト、関数といったさまざまな値がメモリ上に作られます。これらの値の寿命を管理するのが GC の役目です。つまりインタプリタは GC にとって「現場」であり、GC を学ぶには現場を持っているのがいちばんの近道なのです。本書がインタプリタと GC をセットで扱うのはこのためです。
...
- 変数や関数、配列、`if`、ループといった基本的なプログラミングの概念
